  ...
  <header id="header">
    <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
      <div class="container-fluid">
        ...
        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#home-menu"
          aria-controls="home-menu" aria-expanded="false" aria-label="label">
        ...
        <a class="btn d-lg-inline-block my-2 my-md-0 ms-md-3" href="./login/edit.php" id="loginButton">Thông tin cá nhân</a>
        ...
        <div class="row">
          <div class="col-lg-6 col-md-6">
            ...
            <form action="" method="POST">
              ...
              <input type="text" id="contact-name" name="" placeholder="Họ tên (*)"> <br>
              <input type="number" id="contact-phone" name="" placeholder="Điện thoại (*)"> <br>
              <input type="email" id="contact-email" name="" placeholder="Email"> <br>
              <textarea type="text" id="contact-content" name="" placeholder="Nội dung"></textarea> <br>
              <input type="submit" id="contact-submit" name="" value="Gửi">
            </form>
          </div>
          ...
          <div class="col-lg-6 col-md-6">
            ...
            <form action="" method="POST">
              ...
              <input type="text" id="contact-name" name="" placeholder="Tỉnh/Thành"> <br>
              <input type="text" id="contact-name" name="" placeholder="Quận/Huyện"> <br>
              <input type="submit" id="contact-submit" name="" value="Tìm đại lý">
            </form>
          </div>
        </div>
      </div>
